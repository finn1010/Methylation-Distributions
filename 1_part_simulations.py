...
# final_states = run_simulation_diploid(mu, gamma, num_cells = 100, num_timesteps=10)
...
# final_states = run_simulation_trisomy(mu, gamma, num_cells=100, num_timesteps=4)
...
# final_states = run_simulation_tetraploidy(mu, gamma,num_cells=100, num_timesteps=10)
